...
/* PaintEnhanced add 2 buttons to the toolbar: Red, Blue. Press these buttons 
after a shape has been select result in changing the shape's color */
...
public class PaintEnhanced {

	public static void main(String[] args){
		JFrame frame = new JFrame("PaintEnhanced.java");
